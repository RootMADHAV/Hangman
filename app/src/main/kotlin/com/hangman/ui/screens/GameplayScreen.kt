            ...
            Column(
                ...
                Row(
                    ...
                    if (gameStatus.mode.isTimed) {
                        ...
                        AttemptsChip(remaining = gameStatus.remainingAttempts, max = gameStatus.word.difficulty.maxAttempts + 1)
                    }
                }
            ...
            confirmButton = {
                Button(
                    onClick = {
                        ...
                        if (activity != null) {
                            // The hint dialog spec grants +20; SDK reward amount ignored.
                            ...
                            // Preload for next time even if activity lookup fails.
...
private fun DailyChallengeResultScreen(
    ...
    Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        Column(
            ...
            Button(
                onClick = {
                    // Show ad first; the game restarts only when the ad is dismissed.
        ...
        if (adState.showInterstitialAd) {
            Box(
                ...
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    Text("📺 Ad Playing...", fontSize = 20.sp, color = Color.White,
                        fontWeight = FontWeight.Bold)
                    Spacer(modifier = Modifier.height(16.dp))
                    Button(onClick = {
...
private fun TimedSessionSummary(
    navController: NavHostController,
    gameViewModel: GameViewModel,
    uiState: com.hangman.ui.viewmodel.GameUIState
) {
